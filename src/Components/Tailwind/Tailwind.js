    ...
    return (
        ...
        <div className="mb-[2.5vw]">
            ...
            <div className="flex justify-around mt-[2vw] h-[15vw]">
                ...
                <div className="bg-[#E77272] p-[1vw] rounded-[3vw] overflow-hidden">
                    <h3 className="text-center text-[2.5vw] text-[#181818] mb-[1vw]">Advantages:</h3>
                    <ul className="leading-6 text-[#181818] mb-[1vw]">
                        <li className="overflow-hidden">-One rule apply to many elements.</li>
                        <li className="overflow-hidden">-Well documented, deep history with endless posibilites.</li>
                        <li className="overflow-hidden">-Responsive capabilities.</li>
                    </ul>
                </div>
                ...
                <div className="bg-[#E77272] p-[1vw] rounded-[3vw] overflow-hidden">
                    ...
                    <ul className="leading-6 text-[#181818] mb-[1vw]">
                        <li className="overflow-hidden">-Browser support.</li>
                        <li className="overflow-hidden">-Dead code.</li>
                        <li className="overflow-hidden">-Control, change one line could break many things.</li>
                    </ul>
                </div>
            ...
            <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50 bg-[#333333] bg-opacity-50 animate-[fadeIn_.1s_linear]">
                <div className="bg-[#AC93A7] border-[1px] border-[#181818] text-center text-[#181818] p-4 w-[25vw] rounded-3xl overflow-hidden shadow-2xl shadow-[#181818]">
                    ...
                    <form>
                        ...
                        <input className="mb-[1.5vw] w-[20vw] h-[2vw] bg-[#AC93A7] border-[1px] border-[#181818] outline-none text-center rounded-[4px] text-[1vw] hover:border-[#E77272]"></input>
                        <h5 className="text-[1vw]">Idk type your email:</h5>
                        <input className="mb-[1.5vw] w-[20vw] h-[2vw] bg-[#AC93A7] border-[1px] border-[#181818] outline-none text-center rounded-[4px] text-[1vw] hover:border-[#E77272]"></input>
                        <h5 className="text-[1vw]">Select field for fun:</h5>
                        <select className="mb-[1.5vw] w-[20vw] h-[2vw] bg-[#AC93A7] border-[1px] border-[#181818] outline-none text-center rounded-[4px] text-[1vw] hover:border-[#E77272]">
                            <option>option 1</option>
                            <option>option 2</option>
                            <option>option 3</option>
                        </select>
                        <button className="font-pfd-bold text-[1.2vw] text-[#181818] w-[15vw] h-[2vw] bg-[#E77272] border-[1px] border-[#181818] rounded-[4px] transition-all duration-200 ease-linear mb-[1vw]" onClick={toggleModal}>Close</button>
                    </form>
